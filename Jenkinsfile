                        ...
                        secretKeyVariable: 'AWS_SECRET_ACCESS_KEY'
                            ...
                            script {
                                    ...
                                    dir(terraformDirectory) {
                                        ...
                                        def terraformOutputOutput = sh(script: 'terraform output -raw dynamo_api_url > "/var/lib/jenkins/workspace/recipe application build/client/src/environments/dynamo-api-config.json"')
                                    }                        
                            }
                        }                                 
                    }
